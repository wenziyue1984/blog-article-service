package com.wenziyue.blog.article.dal.dto;

import com.wenziyue.blog.article.common.enums.ArticleStatusEnum;
...
public class ArticleDTO implements Serializable {
    ...
    @Schema(description = "作者id", example = "1", requiredMode = Schema.RequiredMode.AUTO)
    private Long userId;
